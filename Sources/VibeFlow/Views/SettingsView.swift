                ...
                if settings.wakeWordEnabled && (subscription.isPro || TrialManager.shared.isTrialActive()) {
                    ...
                    HStack(spacing: 4) {
                        Image(systemName: "info.circle")
                            .foregroundStyle(.secondary)
                            .font(.caption)
                        Text(L10n.wakeWordPreview(settings.wakeWord.isEmpty ? "Vox" : settings.wakeWord))
                            .font(.caption)
                            .foregroundStyle(.secondary)
                    }
                    .padding(.top, 2)
                    ...
                    HStack(spacing: 4) {
                        Image(systemName: "info.circle")
                            .foregroundStyle(.secondary)
                            .font(.caption)
                        Text("Use seu idioma nativo para os comandos \"Vox\", independente do idioma de saída.")
                            .font(.caption)
                            .foregroundStyle(.secondary)
                    }
                    .padding(.top, 2)
